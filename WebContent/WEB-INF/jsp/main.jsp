...
<%
	...
	request.setAttribute("baseurl", baseurl); /*用于引入静态地址的绝对路径*/
%>
<!doctype html>
<html lang="zh-CN">
<head>
...
<link rel="stylesheet"
	href="${baseurl }/resource/css/common.css?<% out.write(String.valueOf(Math.random())); %>">
<!-- Bootstrap -->
<link rel="stylesheet"
	href="http://cdn.bootcss.com/bootstrap/3.3.4/css/bootstrap.min.css">
<link rel="stylesheet"
	href="${baseurl }/resource/css/jquery-ui.min.css">
</head>
...
<body class="user-style-main">
	...
	<div class="container user-style-board">
		...
		<div id="panel" class="user-panel pull-left tab-content">
			<div>
				<div id="list-online" role="tabpanel"
					class="tab-pane active fade in"></div>
		...
		<!-- Modal -->
		<div id="device-detail-modal" class="modal fade" tabindex="-1"
	...
	<script src="${baseurl }/resource/js/jquery-ui.min.js"></script>
	<script
		src="${baseurl }/resource/js/sugar.js?<% out.write(String.valueOf(Math.random())); %>"></script>
</body>
</html>
