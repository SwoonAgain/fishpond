		...
		<div class="navbar-btn-group">
			<div class="col-lg-2 btn-group" id="sort">
				<button type="button" class="btn btn-info dropdown-toggle"
					...
					data-field>
					<span class="glyphicon glyphicon-sort" aria-hidden="true">排序</span><span
						class="caret"></span>
				</button>
			...
			<div class="col-lg-6 input-group" id="filter">
				<div class="input-group-btn">
					<button type="button" class="btn btn-info dropdown-toggle"
						data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
						data-field>
						<span class="glyphicon glyphicon-filter" aria-hidden="true">筛选</span><span
							class="caret"></span>
					</button>
					<ul class="dropdown-menu" role="menu">
...
<div class="wrap-table">
	<%@ include file="allDevicesTable.jsp"%>
</div>
<nav id="paging">
